                    ...
                    <div className="card-body">
                        ...
                        <div className="row gy-lg-4 gy-3">
                            <div className="col-sm-6 col-xs-6">
                                ...
                                <input type="text" className="common-input" value={userData.username} placeholder="First Name" id="FirstNamee"/>
                            </div>
                            <div className="col-sm-6 col-xs-6">
                                <label htmlFor="lastName" className="form-label">Last Name</label>
                                <input type="text" className="common-input" value={userData.username} placeholder="Last Name" id="lastName"/>
                            </div>
                            <div className="col-sm-6 col-xs-6">
                                <label htmlFor="displayName" className="form-label">Display Name</label>
                                <input type="text" className="common-input" value={userData.username} placeholder="Display Name" id="displayName"/>
                            </div>
                            <div className="col-sm-6 col-xs-6">
                                <label htmlFor="DisplayEmail" className="form-label">Display Email</label>
                                <input type="email" className="common-input"  placeholder="Display Email" value={userData.email} id="DisplayEmail"/>
                            </div>
                        </div>
                    </div>
                </div>
