...
const PageLoader = ({ text = "Finding Your Dream Property" }) => {
  return (
    <div className="property-loader-wrapper">
      <div className="property-loader-card">
        {/* Glow Ring Behind Icon */}
        <div className="property-loader-glow-ring"></div>

        {/* Animated UXWing House Color Icon Container */}
        <div className="property-loader-icon-wrap">
          ...
          {/* Exact UXWing House Color Icon SVG */}
          <svg
            className="uxwing-house-svg"
        ...
        {/* Brand Text */}
        <div className="property-loader-brand">
          PROMOTER PROPERTY
        </div>

        {/* Dynamic Subtext */}
        <div className="property-loader-subtext">
          {text}
